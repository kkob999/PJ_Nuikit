...
import { SmartBezierEdge, SmartStepEdge,SmartStraightEdge,svgDrawSmoothLinePath,
	svgDrawStraightLinePath,getSmartEdge } from "@tisoap/react-flow-smart-edge";
...
let ed = [
  { id: "eng#1-2", source: "1", target: "2", type: "smoothstep", animated: false, hidden: false },
  { id: "eng#2-3", source: "2", target: "3", type: "smoothstep", animated: false, hidden: false },
  { id: "eng#3-4", source: "3", target: "4", type: "smoothstep", animated: false, hidden: false},
  { id: "eng#2-4", source: "2", target: "4", type: "smoothstep", animated: false, hidden: false },

  { id: "math#6-7", source: "6", target: "7", type: "smoothstep", animated: false, hidden: false},
  { id: "math#7-8", source: "7", target: "8", type: "smoothstep", animated: false, hidden: false},
  { id: "math#8-9", source: "8", target: "9", type: "smoothstep", animated: false, hidden: false},
